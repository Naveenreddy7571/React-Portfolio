    ...
    <>
      <section id="hero" className={styles.container}>
        ...
        <div className={styles.info}>
          ...
          <p className={styles.description}>Hey there! I'm Naveen, Welcome to my portfolio!

</p>
          <a href="https://drive.google.com/file/d/17PaTlnfd5PQMPcuIscHqOl5rTYgu6G-c/view?usp=sharing" download> 
